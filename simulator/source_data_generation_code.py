...
#Eventhub Configuration
EVENTHUBS_NAMESPACE = "my6-event-hub-nameshpace.servicebus.windows.net"
EVENT_HUB_NAME= "my6eventhub"  
CONNECTION_STRING = "Endpoint=sb://my6-event-hub-nameshpace.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=Dc7e8MNmjzPHMdHU7vJdrOf1yA2arJSGj+AEhIcViIE="
